...
filepath1 = 'E:\\大三上课件\\软件工程（k班）\\Beta\\食品饮料'
filepath2 = 'E:\\大三上课件\\软件工程（k班）\\Beta\\食品饮料2'
filelist = os.listdir(filepath1)

for file in filelist:
    filename1 = filepath1 + '\\' + file
    filename2 = filepath2 + '\\' + file
    handleEncoding(filename1, filename2)